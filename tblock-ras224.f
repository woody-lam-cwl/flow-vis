...
C******************************************************************************
      ...
      CLIFT_OVER_CDRAG_ERROR = ABS((LAST_CLIFT_OVER_CDRAG - 
     & CLIFT_OVER_CDRAG) / CLIFT_OVER_CDRAG)

      IF ( (CLIFT_ERROR > ERROR) .OR. (CDRAG_ERROR > ERROR) .OR.
     & (CLIFT_OVER_CDRAG_ERROR > ERROR)) THEN
      RETURN
      ENDIF
      END DO
